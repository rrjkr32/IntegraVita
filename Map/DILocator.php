...
?>-->
  <head>
	...
	function searchStores(location){
		...
		var parameters = 'lat='+ location.lat() + '&lng=' + location.lng() + '&t=' + t;  
	...
	function displayStores(result){
		if (result.length > 0){
			for (i=0;i<result.length;i++){
				...
				var html = getEmbedHTML(i+1,result[i].dia_name,result[i].address,result[i].distance);
				...
				var msg = 'Location : ' + result[i].dia_name + '<br/> ';
    ...
    <div id="container" class="shadow">
        ...
        <div id="sidebar">
            <div class="row" style="background:#E3EDFA">
              ...
              <select  class="form-control" id="t" required>
