...
function update_price() {
  ...
  update_total();
  var med_name=row.find('.item-name').children().find("textarea").val();
 // window.alert(med_name);
  var current_quantity=row.find('.qty').val();
  //window.alert(current_quantity);
  console.log(med_name);
  console.log(current_quantity);
    var xmlhttp = new XMLHttpRequest();
  var sub="./server.php?cur="+current_quantity+"&med="+med_name;
